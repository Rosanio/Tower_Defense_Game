...
gEngine.Physics = (function() {
    ...
    //n=collision normal, v=velocity, f=friction, m=invMass
    ...
    var resolveCollision = function(s1, s2, collisionInfo) {
        ...
        var s1V = s1.getVelocity();  //collision normal direction is against s2
        ...
        //Step D: compute relative velocity of the colliding objects
        ...
        if(rVelocityInNormal > 0) { //if the objects are moving apart, ignore
            return;
        }
        
        //Step F: conpute and apply response impulses for each object
